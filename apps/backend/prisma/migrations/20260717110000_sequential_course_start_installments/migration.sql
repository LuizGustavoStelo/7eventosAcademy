ALTER TABLE "monthly_charges"
  ...
  ADD COLUMN IF NOT EXISTS "awaiting_course_start" BOOLEAN NOT NULL DEFAULT false;
...
WITH eligible_enrollments AS (
  ...
  INNER JOIN eligible_enrollments target
...
FROM ranked_charges ranked
WHERE charge."id" = ranked."id"
  AND ranked."position" = 1;

CREATE UNIQUE INDEX IF NOT EXISTS "monthly_charges_enrollment_kind_installment_key"
